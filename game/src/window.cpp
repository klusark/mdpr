...
namespace engine{
	namespace window{
		...
		int screenHeight;
		int bitsPerPixel;
		CL_DisplayWindow *windows;

		bool createWindow(int screenWidth, int screenHeight, int bitsPerPixel, std::string title, bool fullScreenFlag)
		{
			...
			windows = new CL_DisplayWindow(title, screenWidth, screenHeight);
